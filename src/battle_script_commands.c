    ...
    if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (gBattleMoves[gCurrentMove].split == SPLIT_PHYSICAL && !(gHitMarker & HITMARKER_PASSIVE_HP_UPDATE) && gCurrentMove != MOVE_PAIN_SPLIT)
                {
                ...
                else if (gBattleMoves[gCurrentMove].split == SPLIT_SPECIAL && !(gHitMarker & HITMARKER_PASSIVE_HP_UPDATE))
                {
