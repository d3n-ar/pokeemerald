...
#define power arg2
    ...
    case PTS_REFLECT:
        ...
        if (gBattleMoves[gCurrentMove].split == SPLIT_PHYSICAL && power != 0 && tvPtr->side[defSide].reflectMonId != 0)
        {
    ...
    case PTS_LIGHT_SCREEN:
        ...
        if (gBattleMoves[gCurrentMove].split == SPLIT_SPECIAL && power != 0 && tvPtr->side[defSide].lightScreenMonId != 0)
        {
